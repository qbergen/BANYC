...
public class BusinessPage extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subjects_navi);

        hamburgerToolBar();

        recycler();
        BusinessCenter.start(getApplicationContext(),rv);
    }
    ...
    private void hamburgerToolBar() {
        toolbar = (Toolbar) findViewById(R.id.toolbar_landingpage);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        drawer = (DrawerLayout) findViewById(R.id.subjects_drawer_layout);
